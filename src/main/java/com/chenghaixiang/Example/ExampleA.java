...
//        System.out.println("遍历结束");
        ...
        System.out.println("A程序计算时间：" + time + "s");
    }
    ...
    public String compress(String msg) throws IOException {
        //我这里用字节流输出的，所以转正byte[]
        byte[] b = msg.getBytes();
        ...
        System.out.println("压缩后长度：" + Arrays.toString(bytes));
        String compressMsg = new String(bytes, "ISO-8859-1");
        System.out.println("压缩后，转String：" +compressMsg.length());
        return compressMsg;
    }
    public  String unZip(String compressMsg) throws IOException {
